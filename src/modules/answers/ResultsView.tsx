            ...
            {appData?.map((data) => {
              ...
              return (
                <ResultsRow
                  ...
                  delays={data.data.settings?.taskSettings.taskBlocksIncluded}
                  rewards={data.data.settings?.taskSettings.taskRewardsIncluded}
                  bounds={data.data.settings?.taskSettings.taskBoundsIncluded}
